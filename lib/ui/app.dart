                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: IndexedStack(
                            ...
                            children: [
                              TranslateScreen(isDark: themeNotifier.isDark),
                              HistoryScreen(isDark: themeNotifier.isDark),
                              DictionaryScreen(isDark: themeNotifier.isDark),
                              SettingsScreen(isDark: themeNotifier.isDark),
                            ],
                          ),
                        ),
                      ),
